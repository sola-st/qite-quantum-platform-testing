...
# <START_GATES>
qc.crx(3.656432, qr[2], qr[3])
qc.rxx(6.205829, qr[3], qr[2])
qc.rv(2.704631, 4.257433, 1.826345, qr[4])
qc.z(qr[4])
qc.mcry(1.814467, [qr[0], qr[3]], qr[2])
qc.sx(qr[0])
qc.sx(qr[1])
qc.tdg(qr[0])
qc.crx(1.832244, qr[3], qr[0])
qc.mcx([qr[3], qr[2], qr[0]], qr[1])
# <END_GATES>

...
# <START_GATES>
qc.ry(2.942613, qr[13])
qc.cswap(qr[14], qr[19], qr[3])
qc.cry(1.423831, qr[12], qr[21])
qc.s(qr[26])
qc.swap(qr[30], qr[24])
qc.cry(3.782535, qr[4], qr[26])
qc.cx(qr[14], qr[30])
qc.rxx(5.464114, qr[28], qr[26])
qc.cp(5.574066, qr[31], qr[21])
qc.sdg(qr[22])
# <END_GATES>

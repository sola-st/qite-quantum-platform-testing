...
# <START_GATES>
qc.mcrz(3.681787, [qr[24]], qr[14])
qc.mcrx(6.192814, [qr[3]], qr[28])
qc.y(qr[8])
qc.cswap(qr[14], qr[5], qr[0])
qc.cry(1.118654, qr[0], qr[3])
qc.cs(qr[29], qr[21])
qc.ryy(2.800499, qr[1], qr[24])
qc.cswap(qr[20], qr[26], qr[7])
qc.rccx(qr[9], qr[2], qr[24])
qc.sx(qr[29])
# <END_GATES>

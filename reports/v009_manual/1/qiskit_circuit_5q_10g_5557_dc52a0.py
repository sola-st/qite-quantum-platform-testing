...
# <START_GATES>
qc = qasm2.loads(
    # Original qasm name: combined_df35197ea5da952e6727e3de4081a36d_45439f04787e5618bf70a7d8c3935f64.qasm . strategy: <class 'generators.knitting.parallel_knitter.ParallelKnitter'>
"""
OPENQASM 2.0;
include "qelib1.inc";
qreg reg_1_q[5];
...
creg reg_2_c[4];
h reg_1_q[0];
cx reg_1_q[0],reg_1_q[1];
cx reg_1_q[1],reg_1_q[2];
cx reg_1_q[2],reg_1_q[3];
cx reg_1_q[3],reg_1_q[4];
cx reg_2_q[1],reg_2_q[2];
h reg_2_q[1];
h reg_2_q[2];
cx reg_2_q[0],reg_2_q[3];
h reg_2_q[3];
